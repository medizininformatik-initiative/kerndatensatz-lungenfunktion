# MII PR Lungenfunktion KCOc - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion KCOc**

## Resource Profile: MII PR Lungenfunktion KCOc 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-kcoc | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_Lungenfunktion_KCOc |

 
The profile describes a observation for the corrected transfer capacity of carbon monoxid. 

This Observation represents the corrected calculated transfer coefficient for carbon monoxide. It is calculated as the corrected diffusing capacity divided by the alveolar volume. The correction is applied using the measured haemoglobin value.

**Usages:**

* Refer to this Profile: [MII PR Lungenfunktion Diffusion](StructureDefinition-mii-pr-lungenfunktion-diffusion.md)
* Examples for this Profile: [Observation/mii-exa-lungenfunktion-kcoc](Observation-mii-exa-lungenfunktion-kcoc.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-kcoc.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-kcoc.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-kcoc.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-kcoc.sch) 
...
```json
{
  ...
  "_name" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lung function_KCOc"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lung function KCOc"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "The profile describes a observation for the corrected transfer capacity of carbon monoxid."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-hb"]
      }]
    },
    {
