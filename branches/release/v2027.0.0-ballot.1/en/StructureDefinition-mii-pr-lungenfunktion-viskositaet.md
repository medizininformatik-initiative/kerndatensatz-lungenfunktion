# MII PR Lungenfunktion Viskosität - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion Viskosität**

## Resource Profile: MII PR Lungenfunktion Viskosität 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-viskositaet | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_Lungenfunktion_Viskositaet |
...
* Derived from this Profile: [MII PR Lungenfunktion R Effektiv](StructureDefinition-mii-pr-lungenfunktion-r-effektiv.md) and [MII PR Lungenfunktion R Spezifisch](StructureDefinition-mii-pr-lungenfunktion-r-spezifisch.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-viskositaet.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-viskositaet.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-viskositaet.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-viskositaet.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Viskositaet",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Viscosity"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Viscosity"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
