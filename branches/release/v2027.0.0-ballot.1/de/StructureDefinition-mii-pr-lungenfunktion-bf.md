# MII PR Lungenfunktion BF - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion BF**

## Ressourcenprofil: MII PR Lungenfunktion BF 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-bf | *Version*:2027.0.0-ballot.1 |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-bf.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-bf.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-bf.sch) 
