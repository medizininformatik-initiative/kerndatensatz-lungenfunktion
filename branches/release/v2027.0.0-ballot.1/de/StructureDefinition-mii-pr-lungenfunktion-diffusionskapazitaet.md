# MII PR Lungenfunktion Diffusionskapzität - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Diffusionskapzität**

## Ressourcenprofil: MII PR Lungenfunktion Diffusionskapzität 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-diffusionskapazitaet | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Diffusionskapzitaet |

 
Dieses Beobachtung beschreibt eine Messung der Diffusionskapazität. 

**Usages:**

* Derived from this Profile: [MII PR Lungenfunktion DLCO](StructureDefinition-mii-pr-lungenfunktion-dlco.md) and [MII PR Lungenfunktion DLCOc](StructureDefinition-mii-pr-lungenfunktion-dlcoc.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-diffusionskapazitaet.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-diffusionskapazitaet.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-diffusionskapazitaet.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-diffusionskapazitaet.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Diffusionskapzitaet",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Diffusioncapacity"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Diffusioncapacity"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
