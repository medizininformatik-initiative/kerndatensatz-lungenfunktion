# Downloads - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2
...
Diese Seite verlinkt die herunterladbaren Artefakte des Moduls **Lungenfunktion (Pulmonary Function)**.
...
Die handgeschriebene Einleitung dazu steht auf der Seite [MII-ImplementationGuide-Ressource](ImplementationGuide-mii-ig-lungenfunktion.md).
...
Über das Paket und die oben genannten Artefakt-Serialisierungen hinaus bietet dieses Modul keine weiteren Downloads an.
