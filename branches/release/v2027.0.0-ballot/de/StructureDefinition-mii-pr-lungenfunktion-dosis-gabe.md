# MII PR Lungenfunktion Dosisgabe - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Dosisgabe**

## Ressourcenprofil: MII PR Lungenfunktion Dosisgabe 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-dosis-gabe | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Dosis_Gabe |

 
Dieses Profil beschreibt die Gabe der Dosis. 

Diese MedicationAdministration beschreibt die Verabreichung des Provokations-Medikament.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-dosis-gabe.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-dosis-gabe.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-dosis-gabe.sch) 
