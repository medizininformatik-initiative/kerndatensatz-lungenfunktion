# MII PR Lungenfunktion FEV/FVC - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion FEV/FVC**

## Resource Profile: MII PR Lungenfunktion FEV/FVC 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-fev-fvc | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-02 | *Computable Name*:MII_PR_Lungenfunktion_FEV_FVC |

 
The profile describes a observation for the tiffeneau. 

This Observation represents the measured ratio of forced expiratory volume to forced vital capacity. Any variant of this measurement can be represented with this resource using the appropriate code from the value set.
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-fev-fvc.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-fev-fvc.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-fev-fvc.sch) 
