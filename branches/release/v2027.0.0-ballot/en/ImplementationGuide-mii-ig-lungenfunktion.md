# MII ImplementationGuide Resource - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot
...
* [ATC](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.5.4&canonical=http://fhir.de/CodeSystem/bfarm/atc): [MII_PR_Lungenfunktion_Dosis_Gabe](StructureDefinition-mii-pr-lungenfunktion-dosis-gabe.md) and [MII_PR_Lungenfunktion_Methacholine](StructureDefinition-mii-pr-lungenfunktion-methacholine.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "MII Example Lungenfunktion ERV",
      "exampleCanonical" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-irv-erv"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "name" : "MII Example Lungenfunktion Provokation sR tot Base",
    ...
    },
    {
      ...
      "name" : "MII Example Lungenfunktion Provokation sR tot P3",
      "exampleCanonical" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-r-spezifisch"
    },
    {
      "extension" : [{
      ...
      "name" : "MII Example Lungenfunktion Provokation sR tot P4",
      "exampleCanonical" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-r-spezifisch"
    },
    {
      "extension" : [{
      ...
      "name" : "MII Example Lungenfunktion Provokation sR tot P5",
      "exampleCanonical" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-r-spezifisch"
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Observation-mii-exa-lungenfunktion-rv.html"
      }],
      "reference" : {
        "reference" : "Observation/mii-exa-lungenfunktion-rv"
      },
      "name" : "MII Example Lungenfunktion RV",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Observation-mii-exa-lungenfunktion-rv-tlc.html"
      }],
      "reference" : {
        "reference" : "Observation/mii-exa-lungenfunktion-rv-tlc"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-mii-pr-lungenfunktion-rv-tlc.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/mii-pr-lungenfunktion-rv-tlc"
      },
    ...
    },
    {
      ...
      "name" : "MII PR Lungenfunktion Diffusionskapzität",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-mii-pr-lungenfunktion-irv-erv.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/mii-pr-lungenfunktion-irv-erv"
      },
      "name" : "MII PR Lungenfunktion Reserve Volumen",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-mii-pr-lungenfunktion-rv.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/mii-pr-lungenfunktion-rv"
      },
    ...
    },
    {
      ...
      "name" : "MII PR Lungenfunktion Viskosität",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-mii-vs-lufu-lnc-irv-erv.html"
      }],
      "reference" : {
        "reference" : "ValueSet/mii-vs-lufu-lnc-irv-erv"
      },
      "name" : "MII VS Lufu LNC IRV & ERV",
    ...
    },
    {
      ...
      "name" : "MII VS Lufu LNC Observable",
    ...
    },
    {
      ...
      "name" : "MII VS Lufu LNC Procedure Report",
      "description" : "Import the ValueSet for lungfunction",
      "exampleBoolean" : false
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-mii-vs-lufu-lnc-rv-tlc.html"
      }],
      "reference" : {
        "reference" : "ValueSet/mii-vs-lufu-lnc-rv-tlc"
      },
      "name" : "MII VS Lufu LNC RV TLC",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-mii-vs-lufu-sct-irv-erv.html"
      }],
      "reference" : {
        "reference" : "ValueSet/mii-vs-lufu-sct-irv-erv"
      },
      "name" : "MII VS Lufu SCT IRV & ERV",
      "description" : "Import the ValueSet for lungfunction reserve volume",
      "exampleBoolean" : false
    },
    {
