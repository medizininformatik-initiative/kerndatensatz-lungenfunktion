# MII PR Lungenfunktion Umgebung - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion Umgebung**

## Resource Profile: MII PR Lungenfunktion Umgebung 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-umgebung | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-02 | *Computable Name*:MII_PR_Lungenfunktion_Umgebung |

 
The profile describes the patients location. 

This Location represents the environment the patient is in.
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-umgebung.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-umgebung.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-umgebung.sch) 
