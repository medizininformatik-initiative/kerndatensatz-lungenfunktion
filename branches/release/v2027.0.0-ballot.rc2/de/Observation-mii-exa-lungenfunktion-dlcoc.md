# MII Example Lungenfunktion DLCOc - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII Example Lungenfunktion DLCOc**

## Beispiel Observation: MII Example Lungenfunktion DLCOc
...
Profile: [MII PR Lungenfunktion DLCOc](StructureDefinition-mii-pr-lungenfunktion-dlcoc.md)
...
* [Observation Hemoglobin [Mass/volume] in Blood](Observation-mii-exa-lungenfunktion-hb.md)
* [Observation Diffusion capacity.carbon monoxide](Observation-mii-exa-lungenfunktion-dlco.md)
...
```json
{
  ...
  "id" : "mii-exa-lungenfunktion-dlcoc",
  "meta" : {
