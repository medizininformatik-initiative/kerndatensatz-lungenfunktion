# MII PR Lungenfunktion Spirometrie - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Spirometrie**

## Ressourcenprofil: MII PR Lungenfunktion Spirometrie 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-spirometrie | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Spirometrie |

 
Diese Ressource beschreibt einen Befunde der Spirometrie 

Der Befund der Spirometire wird in diesem DiagnosticReport abgebildet. Die Messwerte sind als Observation referenziert.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-spirometrie.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-spirometrie.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-spirometrie.sch) 
