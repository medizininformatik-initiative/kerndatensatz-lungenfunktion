# MII PR Lungenfunktion Volumen - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Volumen**

## Ressourcenprofil: MII PR Lungenfunktion Volumen 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-volumen | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Volumen |

 
Dieses Beobachtung beschreibt eine Volumenmessung. 

**Usages:**

* Derived from this Profile: [MII PR Lungenfunktion FEV](StructureDefinition-mii-pr-lungenfunktion-fev.md), [MII PR Lungenfunktion FRC](StructureDefinition-mii-pr-lungenfunktion-frc.md), [MII PR Lungenfunktion FVC](StructureDefinition-mii-pr-lungenfunktion-fvc.md), [MII PR Lungenfunktion IC](StructureDefinition-mii-pr-lungenfunktion-ic.md)... Show 5 more, [MII PR Lungenfunktion Reserve Volumen](StructureDefinition-mii-pr-lungenfunktion-irv-erv.md), [MII PR Lungenfunktion RV](StructureDefinition-mii-pr-lungenfunktion-rv.md), [MII PR Lungenfunktion TLC](StructureDefinition-mii-pr-lungenfunktion-tlc.md), [MII PR Lungenfunktion VA](StructureDefinition-mii-pr-lungenfunktion-va.md) and [MII PR Lungenfunktion VC](StructureDefinition-mii-pr-lungenfunktion-vc.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-volumen.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-volumen.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-volumen.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-volumen.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Volumen",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Volume"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Volume"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "Teil von einer Lungenfunktionsprozedur",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Teil von einer Lungenfunktionsprozedur"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
    ...
    },
    {
      ...
      "definition" : "Zeitpunkt, an dem die Beobachtung der Untersuchung dokumentiert wurde",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
    ...
    },
    {
      ...
      "definition" : "Messwert der Beobachtung",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Messwert der Beobachtung"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
          ...
          {
            "url" : "content",
            "valueString" : "Value of the observation"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
    ...
    },
    {
      ...
      "definition" : "Interpretation des Messwertes",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Interpretation des Messwertes"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
    ...
    },
    {
      ...
      "definition" : "Methode, mit der dieser Messwert erfasst wurde",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Methode, mit der dieser Messwert erfasst wurde"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
    ...
    },
    {
      ...
      "definition" : "Abgeleitet von Messwerten, ect.",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
    ...
    },
    {
      ...
      "definition" : "Z-Score mit GLI-Referenztabellen",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "z-Score der Messung"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
          ...
          {
            "url" : "content",
            "valueString" : "z-score of measurement"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
    ...
    {
      "id" : "Observation.component:z-score.code.coding",
      "path" : "Observation.component.code.coding",
      "slicing" : {
        "discriminator" : [{
          "type" : "value",
    ...
    {
      "id" : "Observation.component:z-score.code.coding:sct",
      "path" : "Observation.component.code.coding",
      "sliceName" : "sct",
      "short" : "SNOMED CT Code",
      "_short" : {
