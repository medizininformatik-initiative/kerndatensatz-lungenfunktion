...
## Ressourcenprofil: MII PR Lungenfunktion IC 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-ic | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_IC |

 
Dieses Profil beschreibt die Messung der inspiratorischen Kapazität. 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-ic.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-ic.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-ic.sch) 
