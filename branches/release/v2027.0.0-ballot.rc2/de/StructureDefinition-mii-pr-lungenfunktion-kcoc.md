...
## Ressourcenprofil: MII PR Lungenfunktion KCOc 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-kcoc | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_KCOc |

 
Dieses Profil beschreibt die Messung der korrigierten Transferkapzität von Kohlenstoffmonoxid. 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-kcoc.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-kcoc.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-kcoc.sch) 
