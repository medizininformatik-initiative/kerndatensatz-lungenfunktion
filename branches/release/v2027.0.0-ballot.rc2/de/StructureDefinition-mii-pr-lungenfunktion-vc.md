# MII PR Lungenfunktion VC - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion VC**

## Ressourcenprofil: MII PR Lungenfunktion VC 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-vc | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_VC |

 
Dieses Profil beschreibt die Messung der maximalen Vitalkapazität bei Ausatmung. 

Diese Observation beschreibt die gemessene Vitalkapzität.
...
* Examples for this Profile: [Observation/mii-exa-lungenfunktion-vc](Observation-mii-exa-lungenfunktion-vc.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-vc.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-vc.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-vc.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-vc.sch) 
...
```json
{
  ...
  "_name" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_VC"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction VC"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "The profile describes a observation for the maximum vital capacity."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/ValueSet/mii-vs-lufu-sct-vc"
      }
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/ValueSet/mii-vs-lufu-lnc-vc"
      }
    },
    {
