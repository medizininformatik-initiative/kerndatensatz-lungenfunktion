# MII PR Lungenfunktion Prozent - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Prozent**

## Ressourcenprofil: MII PR Lungenfunktion Prozent 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-prozent | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Prozent |

 
Dieses Beobachtung beschreibt einen prozentualen Anteil. 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-prozent.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-prozent.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-prozent.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Prozent",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Percent"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Percent"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
