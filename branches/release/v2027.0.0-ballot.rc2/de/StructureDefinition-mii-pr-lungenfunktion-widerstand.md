# MII PR Lungenfunktion Widerstand - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Widerstand**

## Ressourcenprofil: MII PR Lungenfunktion Widerstand 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-widerstand | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Widerstand |

 
Dieses Beobachtung beschreibt eine Widerstandsmessung. 

**Usages:**

* Derived from this Profile: [MII PR Lungenfunktion R](StructureDefinition-mii-pr-lungenfunktion-r.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-widerstand.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-widerstand.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-widerstand.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-widerstand.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Widerstand",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Resistence"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Resistence"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
