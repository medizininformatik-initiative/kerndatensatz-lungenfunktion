# MII PR Lungenfunktion Spirometire Messung - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Spirometire Messung**

## Ressourcenprofil: MII PR Lungenfunktion Spirometire Messung 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-spirometrie-messung | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Spirometrie_Messung |

 
Beschreibt die Tätigkeiten, wie eine Spirometrie durchgeführt wird. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.json)
...
* [MII PR Lungenfunktion Spirometrie (https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-spirometrie)](StructureDefinition-mii-pr-lungenfunktion-spirometrie.md)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Spirometrie_Messung",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Spirometry_Measurement"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Spirometry Measurement"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-spirometrie"]
      }],
      "mustSupport" : true
    }]
  }
