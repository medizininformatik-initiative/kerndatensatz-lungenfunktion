# MII PR Lungenfunktion Transferkoeffizient - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Transferkoeffizient**

## Ressourcenprofil: MII PR Lungenfunktion Transferkoeffizient 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-transferkoeffizient | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-02 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Transferkoeffizient |

 
Dieses Beobachtung beschreibt ein Transferkoeffizient. 

**Usages:**

* Derived from this Profile: [MII PR Lungenfunktion KCO](StructureDefinition-mii-pr-lungenfunktion-kco.md) and [MII PR Lungenfunktion KCOc](StructureDefinition-mii-pr-lungenfunktion-kcoc.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-transferkoeffizient.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-transferkoeffizient.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-transferkoeffizient.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-transferkoeffizient.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Transferkoeffizient",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Transfercoefficient"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Transfercoefficient"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
