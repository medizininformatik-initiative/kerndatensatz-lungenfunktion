# MII PR Lungenfunktion Provokationstest - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion Provokationstest**

## Ressourcenprofil: MII PR Lungenfunktion Provokationstest 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-provokationstest | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Provokationstest |

 
Diese Ressource beschreibt einen Befunde des Provokationstest 

Der Befund des Provokationstests wird in diesem DiagnosticReport abgebildet. Die Messwerte sind als Observation referenziert.
...
* [MII PR Lungenfunktion Dosis (https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-dosis)](StructureDefinition-mii-pr-lungenfunktion-dosis.md)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-provokationstest.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-provokationstest.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-provokationstest.sch) 
