# MII Example Lungenfunktion Provokation FRC P4 - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII Example Lungenfunktion Provokation FRC P4**

## Beispiel Observation: MII Example Lungenfunktion Provokation FRC P4
...
```json
{
  ...
  "id" : "mii-exa-lungenfunktion-frc-p4",
  "meta" : {
