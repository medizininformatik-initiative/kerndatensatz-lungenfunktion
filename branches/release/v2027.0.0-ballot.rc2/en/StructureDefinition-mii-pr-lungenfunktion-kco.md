# MII PR Lungenfunktion KCO - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion KCO**

## Resource Profile: MII PR Lungenfunktion KCO 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-kco | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-02 | *Computable Name*:MII_PR_Lungenfunktion_KCO |

 
The profile describes a observation for the transfer capacity of carbon monoxid. 
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-kco.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-kco.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-kco.sch) 
