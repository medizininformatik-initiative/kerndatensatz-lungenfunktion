...
## Resource Profile: MII PR Lungenfunktion Spirometire Messung 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-spirometrie-messung | *Version*:2027.0.0-ballot.rc1 |
| Active as of 2026-09-01 | *Computable Name*:MII_PR_Lungenfunktion_Spirometrie_Messung |

 
The profile describes a advisory for medical care 

This Procedure represents the spirometry measurement procedure.
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-spirometrie-messung.sch) 
