# Versioning - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2
...
The **Lungenfunktion (Pulmonary Function)** module follows the KDS calendar-versioning (CalVer) scheme in a SemVer-compatible numeric form:
...
This module follows the KDS versioning scheme without additions of its own; there is no separate support window or deprecation policy.
