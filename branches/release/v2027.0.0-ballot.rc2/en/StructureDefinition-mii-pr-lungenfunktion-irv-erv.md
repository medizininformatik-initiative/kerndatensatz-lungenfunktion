# MII PR Lungenfunktion Reserve Volumen - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion Reserve Volumen**

## Resource Profile: MII PR Lungenfunktion Reserve Volumen 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-irv-erv | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-02 | *Computable Name*:MII_PR_Lungenfunktion_IRV_ERV |

 
The profile describes a observation for the reserve volume. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-irv-erv.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-irv-erv.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-irv-erv.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-irv-erv.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_IRV_ERV",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_IRV_ERV"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Reserve Volume"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/ValueSet/mii-vs-lufu-sct-irv-erv"
      }
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/ValueSet/mii-vs-lufu-lnc-irv-erv"
      }
    },
    {
