# MII PR Lungenfunktion Luftfeuchtigkeit - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Lungenfunktion Luftfeuchtigkeit**

## Resource Profile: MII PR Lungenfunktion Luftfeuchtigkeit 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-luftfeuchtigkeit | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-02 | *Computable Name*:MII_PR_Lungenfunktion_Luftfeuchtigkeit |

 
The profile describes a observation for humidity. 

This Observation represents the measured air humidity in the patient's environment.

**Usages:**

* Examples for this Profile: [Observation/mii-exa-lungenfunktion-luftfeuchtigkeit](Observation-mii-exa-lungenfunktion-luftfeuchtigkeit.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-luftfeuchtigkeit.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-lungenfunktion-luftfeuchtigkeit.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-luftfeuchtigkeit.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-luftfeuchtigkeit.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Luftfeuchtigkeit",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Humidity"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Humidity"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "The profile describes a observation for humidity."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
