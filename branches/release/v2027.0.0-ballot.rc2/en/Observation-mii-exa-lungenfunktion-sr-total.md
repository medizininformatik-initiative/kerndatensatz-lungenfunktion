# MII Example Lungenfunktion R tot - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII Example Lungenfunktion R tot**

## Example Observation: MII Example Lungenfunktion R tot
...
> **component****code**: Airway resistance measured/predicted by Plethysmograph body box**value**: 130 % (Details: UCUM code% = '%')
...
```json
{
  ...
  "id" : "mii-exa-lungenfunktion-sr-total",
  "meta" : {
