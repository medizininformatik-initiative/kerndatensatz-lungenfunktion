# Capability Statements - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1
...
The technical detail view is available on the artifact page [MII_CPS_Lungenfunktion](CapabilityStatement-mii-cps-lungenfunktion-capabilitystatement.md).
