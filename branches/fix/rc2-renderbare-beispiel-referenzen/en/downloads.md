...
This page links the downloadable artifacts of the **Lungenfunktion (Pulmonary Function)** module.
...
The hand-authored intro to it is on the page [MII ImplementationGuide Resource](ImplementationGuide-mii-ig-lungenfunktion.md).

#### Version history

Earlier versions and the detailed change history are on the [Versioning](version-history.md) and [Changelog](changes.md) pages.

This module offers no further downloads beyond the package and the artifact serializations listed above.
