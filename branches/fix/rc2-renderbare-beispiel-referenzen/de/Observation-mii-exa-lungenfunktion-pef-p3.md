# MII Example Lungenfunktion Provokation PEF P3 - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII Example Lungenfunktion Provokation PEF P3**

## Beispiel Observation: MII Example Lungenfunktion Provokation PEF P3
...
```json
{
  ...
  "id" : "mii-exa-lungenfunktion-pef-p3",
  "meta" : {
