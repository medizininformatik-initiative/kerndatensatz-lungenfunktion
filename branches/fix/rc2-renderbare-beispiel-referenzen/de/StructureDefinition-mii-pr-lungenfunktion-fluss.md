...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-fluss | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_Fluss |
...
* Derived from this Profile: [MII PR Lungenfunktion MEF](StructureDefinition-mii-pr-lungenfunktion-mef.md) and [MII PR Lungenfunktion PEF](StructureDefinition-mii-pr-lungenfunktion-pef.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.lungenfunktion|current/StructureDefinition/StructureDefinition-mii-pr-lungenfunktion-fluss.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-fluss.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-fluss.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-fluss.sch) 
...
```json
{
  ...
  "name" : "MII_PR_Lungenfunktion_Fluss",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Lungfunction_Flow"
      }],
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "MII PR Lungfunction Flow"
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
