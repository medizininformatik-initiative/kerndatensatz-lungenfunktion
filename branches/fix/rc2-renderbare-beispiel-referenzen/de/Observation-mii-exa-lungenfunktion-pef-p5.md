# MII Example Lungenfunktion Provokation PEF P5 - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII Example Lungenfunktion Provokation PEF P5**

## Beispiel Observation: MII Example Lungenfunktion Provokation PEF P5
...
```json
{
  ...
  "id" : "mii-exa-lungenfunktion-pef-p5",
  "meta" : {
