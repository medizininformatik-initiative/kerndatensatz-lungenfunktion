# MII PR Lungenfunktion R Spezifisch - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Lungenfunktion R Spezifisch**

## Ressourcenprofil: MII PR Lungenfunktion R Spezifisch 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-r-spezifisch | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Lungenfunktion_R_Spezifisch |

 
Dieses Profil beschreibt die Messung des spezifischen Atemwegswiderstand 

Diese Observation beschreibt den gemessene totalen, spezifischen Atemwegswiderstand.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-lungenfunktion-r-spezifisch.csv), [Excel](../StructureDefinition-mii-pr-lungenfunktion-r-spezifisch.xlsx), [Schematron](../StructureDefinition-mii-pr-lungenfunktion-r-spezifisch.sch) 
