# Versionierung - MII IG Kerndatensatz-Modul Lungenfunktion v2027.0.0-ballot.rc1
...
Das Modul **Lungenfunktion (Pulmonary Function)** folgt dem KDS-Schema der Kalender-Versionierung (CalVer) in einer SemVer-kompatiblen numerischen Form:
...
Dieses Modul folgt dem KDS-Versionierungsschema ohne eigene Ergänzungen; es gibt kein gesondertes Support-Fenster und keine eigene Deprecation-Policy.
