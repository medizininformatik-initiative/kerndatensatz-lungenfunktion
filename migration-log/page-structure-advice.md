...
| artefact census | fsh-generated/resources (145 resources; cross-checked by Gate 0's generated_crosscheck) |
| page map | `migration-log/page-map.generated.tsv` |
| generated | 2026-08-28T14:18:44Z |
...
| `mii-ig-lungenfunktion-de-v2026` | MII IG Lungenfunktion DE v2026 | 2026 | 2026.0.0 | DE | 56 | **AUTHORITATIVE** - steps 5.4/5.5 operate on this tree |
...
Maximum depth used: **5**. Total words across the 56 source pages: **8106**. Pages in `input/pagecontent/`: **0**.
...
- `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/toc.yaml` lists `TA.page.md`, but the **page file does not exist** - the entry is dangling and produced no page.
...
`- Index  `MIIIGModulLungenfunktion/Index.page.md`
   ...
   |  `- UML  `MIIIGModulLungenfunktion/AnwendungsflleInformationsmodell/UML.page.md`
   `- Index  `MIIIGModulLungenfunktion/TechnischeImplementierung/Index.page.md`
      ...
      `- Index  `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Index.page.md`
         ...
         |  |- Provokationsdosis  `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Dosis.page.md`
         |  |- Provokationsmedikation  `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Medikation.page.md`
         |  `- Provokationsgabe  `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Provokationsgabe.page.md`
...
| ---: | --- | ---: | ---: | ---: | --- | --- | --- |
| 1 | `MIIIGModulLungenfunktion/Index.page.md` | 1 | 6 | 297 | 3 merge into agreed page | index.md | agreed page named 'index' exists in the target |
| 2 | `MIIIGModulLungenfunktion/Release-Notes.page.md` | 1 | 0 | 6 | 3 merge into agreed page | changes.md | semantic match 'releasenotes' -> changes (routing-table) |
| 3 | `MIIIGModulLungenfunktion/BeschreibungModul.page.md` | 1 | 0 | 598 | 3 merge into agreed page | index.md | semantic match 'beschreibungmodul' -> index (routing-table) |
| 4 | `MIIIGModulLungenfunktion/KontextimGesamtprojektBezgezuanderenModulen.page.md` | 1 | 0 | 598 | 3 merge into agreed page | implementer-guidance.md | semantic match 'kontextimgesamtprojekt' -> implementer-guidance (routing-table) |
| 5 | `MIIIGModulLungenfunktion/Referenzen.page.md` | 1 | 0 | 104 | 3 merge into agreed page | implementer-guidance.md | semantic match 'referenzen' -> implementer-guidance (routing-table) |
...
| 7 | `MIIIGModulLungenfunktion/AnwendungsflleInformationsmodell/BeschreibungvonSzenarienfrdieAnwendungderModule.page.md` | 2 | 0 | 471 | 3 merge into agreed page | guidance.md | semantic match 'szenarien' -> guidance (routing-table) |
| 8 | `MIIIGModulLungenfunktion/AnwendungsflleInformationsmodell/Datensaetze_inkl._Beschreibungen.page.md` | 2 | 0 | 128 | 3 merge into agreed page | logical-models.md | semantic match 'datensaetze' -> logical-models (routing-table) |
| 9 | `MIIIGModulLungenfunktion/AnwendungsflleInformationsmodell/UML.page.md` | 2 | 0 | 6 | 3 merge into agreed page | uml-diagrams.md | semantic match 'uml' -> uml-diagrams (routing-table) |
...
| 14 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Index.page.md` | 4 | 3 | 11 | 2 section on index page | h3/h4 section on value-sets.md <br>_(folder landing page - NOT matched against the target's index.md or an artefact id; routed by its own children)_ | 3 children, 2 anchoring distinct artefacts (ValueSet) |
| 15 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Procedure.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/ValueSet-mii-vs-lufu-lnc-procedure-intro.md | compact match on mii-vs-lufu-lnc-procedure (2 candidate artefacts) |
| 16 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Report.page.md` | 4 | 0 | 148 | 2 section on index page | h3/h4 section on value-sets.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Index.page.md (no anchor of its own) |
| 17 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/FRC.page.md` | 5 | 7 | 140 | 2 section on index page | h3/h4 section on profiles.md | 7 children, 5 anchoring distinct artefacts (StructureDefinition) |
| 18 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/R_tot.page.md` | 5 | 0 | 141 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/FRC.page.md (no anchor of its own) |
| 19 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/sR_tot.page.md` | 5 | 0 | 142 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/FRC.page.md (no anchor of its own) |
| 20 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/sR_eff.page.md` | 5 | 0 | 142 | 1 intro-note | input/intro-notes/ValueSet-mii-vs-lufu-lnc-sr-eff-intro.md | compact match on mii-vs-lufu-lnc-sr-eff (1 candidate artefact) |
| 21 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/sG_tot.page.md` | 5 | 0 | 144 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-sg-total-intro.md | compact match on mii-pr-lungenfunktion-sg-total (1 candidate artefact; intro note already present) |
| 22 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/TLC.page.md` | 5 | 0 | 140 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-tlc-intro.md | tokens match on mii-pr-lungenfunktion-tlc (4 candidate artefacts; intro note already present) |
| 23 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/RVL.page.md` | 5 | 0 | 139 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-rvl-intro.md | tokens match on mii-pr-lungenfunktion-rvl (4 candidate artefacts; intro note already present) |
| 24 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/RVLTLC.page.md` | 5 | 0 | 146 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-rvl-tlc-intro.md | compact match on mii-pr-lungenfunktion-rvl-tlc (2 candidate artefacts; intro note already present) |
| 25 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Index.page.md` | 4 | 3 | 11 | 2 section on index page | h3/h4 section on value-sets.md <br>_(folder landing page - NOT matched against the target's index.md or an artefact id; routed by its own children)_ | 3 children, 2 anchoring distinct artefacts (ValueSet) |
| 26 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Procedure.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/ValueSet-mii-vs-lufu-lnc-procedure-intro.md | compact match on mii-vs-lufu-lnc-procedure (2 candidate artefacts) |
| 27 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Report.page.md` | 4 | 0 | 148 | 2 section on index page | h3/h4 section on value-sets.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Index.page.md (no anchor of its own) |
| 28 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/DLCO.page.md` | 5 | 5 | 143 | 2 section on index page | h3/h4 section on profiles.md | 5 children, 3 anchoring distinct artefacts (StructureDefinition) |
| 29 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/DLCOc.page.md` | 5 | 0 | 152 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-dlcoc-intro.md | compact match on mii-pr-lungenfunktion-dlcoc (2 candidate artefacts; intro note already present) |
| 30 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/KCO.page.md` | 5 | 0 | 152 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-kco-intro.md | tokens match on mii-pr-lungenfunktion-kco (2 candidate artefacts; intro note already present) |
| 31 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/KCOc.page.md` | 5 | 0 | 162 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-kcoc-intro.md | compact match on mii-pr-lungenfunktion-kcoc (1 candidate artefact; intro note already present) |
| 32 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/VA.page.md` | 5 | 0 | 140 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/DLCO.page.md (no anchor of its own) |
| 33 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/Hb.page.md` | 5 | 0 | 139 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/DLCO.page.md (no anchor of its own) |
| 34 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md` | 4 | 5 | 11 | 2 section on index page | h3/h4 section on value-sets.md <br>_(folder landing page - NOT matched against the target's index.md or an artefact id; routed by its own children)_ | 5 children, 2 anchoring distinct artefacts (ValueSet) |
| 35 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Procedure.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/ValueSet-mii-vs-lufu-lnc-procedure-intro.md | compact match on mii-vs-lufu-lnc-procedure (2 candidate artefacts) |
| 36 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Report.page.md` | 4 | 0 | 148 | 2 section on index page | h3/h4 section on value-sets.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md (no anchor of its own) |
| 37 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Dosis.page.md` | 4 | 0 | 155 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-dosis-intro.md | compact match on mii-pr-lungenfunktion-dosis (2 candidate artefacts) |
| 38 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Medikation.page.md` | 4 | 0 | 138 | 2 section on index page | h3/h4 section on value-sets.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md (no anchor of its own) |
| 39 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Provokationsgabe.page.md` | 4 | 0 | 140 | 2 section on index page | h3/h4 section on value-sets.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md (no anchor of its own) |
| 40 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Index.page.md` | 4 | 3 | 11 | 4 own page | own page (HUB), pages:-NESTED under MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Index.page.md (its host has no menu entry) <br>_(folder landing page - NOT matched against the target's index.md or an artefact id; routed by its own children)_ | no artefact anchor; no agreed page; 3 child page(s) |
| 41 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Procedure.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/ValueSet-mii-vs-lufu-lnc-procedure-intro.md | compact match on mii-vs-lufu-lnc-procedure (2 candidate artefacts) |
| 42 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Report.page.md` | 4 | 0 | 148 | 4 own page | own page (merged page), pages:-NESTED under MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Index.page.md (its host has no menu entry) | no artefact anchor; no agreed page; 0 child page(s) |
| 43 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/BF.page.md` | 5 | 8 | 139 | 2 section on index page | h3/h4 section on profiles.md | 8 children, 5 anchoring distinct artefacts (StructureDefinition) |
| 44 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/FEV.page.md` | 5 | 0 | 142 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-fev-intro.md | tokens match on mii-pr-lungenfunktion-fev (6 candidate artefacts; intro note already present) |
| 45 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/FEVFVC.page.md` | 5 | 0 | 163 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-fev-fvc-intro.md | compact match on mii-pr-lungenfunktion-fev-fvc (3 candidate artefacts; intro note already present) |
| 46 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/FVC.page.md` | 5 | 0 | 140 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-fvc-intro.md | tokens match on mii-pr-lungenfunktion-fvc (6 candidate artefacts; intro note already present) |
| 47 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/IC.page.md` | 5 | 0 | 140 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/BF.page.md (no anchor of its own) |
| 48 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/MEF.page.md` | 5 | 0 | 177 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-mef-intro.md | tokens match on mii-pr-lungenfunktion-mef (3 candidate artefacts; intro note already present) |
| 49 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/PEF.page.md` | 5 | 0 | 139 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-pef-intro.md | tokens match on mii-pr-lungenfunktion-pef (3 candidate artefacts; intro note already present) |
| 50 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/RV.page.md` | 5 | 0 | 139 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/BF.page.md (no anchor of its own) |
| 51 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/VC.page.md` | 5 | 0 | 139 | 2 section on index page | h3/h4 section on profiles.md | child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/BF.page.md (no anchor of its own) |
| 52 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Index.page.md` | 4 | 4 | 11 | 2 section on index page | h3/h4 section on profiles.md <br>_(folder landing page - NOT matched against the target's index.md or an artefact id; routed by its own children)_ | 4 children, 4 anchoring distinct artefacts (StructureDefinition) |
| 53 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Umgebung.page.md` | 4 | 0 | 144 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-umgebung-intro.md | compact match on mii-pr-lungenfunktion-umgebung (1 candidate artefact; intro note already present) |
| 54 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Lufttemperatur.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-lufttemperatur-intro.md | compact match on mii-pr-lungenfunktion-lufttemperatur (1 candidate artefact; intro note already present) |
| 55 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Luftfeuchtigkeit.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-luftfeuchtigkeit-intro.md | compact match on mii-pr-lungenfunktion-luftfeuchtigkeit (1 candidate artefact; intro note already present) |
| 56 | `MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/CO2-Konzentration.page.md` | 4 | 0 | 142 | 1 intro-note | input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-co2-konzentration-intro.md | compact match on mii-pr-lungenfunktion-co2-konzentration (1 candidate artefact; intro note already present) |

Branch totals: 1 intro-note = 22, 2 section on index page = 19, 3 merge into agreed page = 10, 4 own page = 5.
...
5.4c page-routing	MIIIGModulLungenfunktion/AnwendungsflleInformationsmodell/UML.page.md	branch=3	uml-diagrams.md	semantic match 'uml' -> uml-diagrams (routing-table)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/sG_tot.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-sg-total-intro.md	compact match on mii-pr-lungenfunktion-sg-total (1 candidate artefact; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/TLC.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-tlc-intro.md	tokens match on mii-pr-lungenfunktion-tlc (4 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/RVL.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-rvl-intro.md	tokens match on mii-pr-lungenfunktion-rvl (4 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Bodyplethysmographie/Observation/RVLTLC.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-rvl-tlc-intro.md	compact match on mii-pr-lungenfunktion-rvl-tlc (2 candidate artefacts; intro note already present)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/DLCO.page.md	branch=2	h3/h4 section on profiles.md	5 children, 3 anchoring distinct artefacts (StructureDefinition)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/DLCOc.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-dlcoc-intro.md	compact match on mii-pr-lungenfunktion-dlcoc (2 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/KCO.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-kco-intro.md	tokens match on mii-pr-lungenfunktion-kco (2 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Diffusion/Observation/KCOc.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-kcoc-intro.md	compact match on mii-pr-lungenfunktion-kcoc (1 candidate artefact; intro note already present)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md	branch=2	h3/h4 section on value-sets.md	5 children, 2 anchoring distinct artefacts (ValueSet)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Dosis.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-dosis-intro.md	compact match on mii-pr-lungenfunktion-dosis (2 candidate artefacts)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Medikation.page.md	branch=2	h3/h4 section on value-sets.md	child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md (no anchor of its own)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Provokationsgabe.page.md	branch=2	h3/h4 section on value-sets.md	child of family overview MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Provokationstest/Index.page.md (no anchor of its own)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/BF.page.md	branch=2	h3/h4 section on profiles.md	8 children, 5 anchoring distinct artefacts (StructureDefinition)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/FEV.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-fev-intro.md	tokens match on mii-pr-lungenfunktion-fev (6 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/FEVFVC.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-fev-fvc-intro.md	compact match on mii-pr-lungenfunktion-fev-fvc (3 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/FVC.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-fvc-intro.md	tokens match on mii-pr-lungenfunktion-fvc (6 candidate artefacts; intro note already present)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/MEF.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-mef-intro.md	tokens match on mii-pr-lungenfunktion-mef (3 candidate artefacts; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Spirometrie/Observation/PEF.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-pef-intro.md	tokens match on mii-pr-lungenfunktion-pef (3 candidate artefacts; intro note already present)
...
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Umgebung.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-umgebung-intro.md	compact match on mii-pr-lungenfunktion-umgebung (1 candidate artefact; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Lufttemperatur.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-lufttemperatur-intro.md	compact match on mii-pr-lungenfunktion-lufttemperatur (1 candidate artefact; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/Luftfeuchtigkeit.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-luftfeuchtigkeit-intro.md	compact match on mii-pr-lungenfunktion-luftfeuchtigkeit (1 candidate artefact; intro note already present)
5.4c page-routing	MIIIGModulLungenfunktion/TechnischeImplementierung/FHIR-Profile/Umgebungsvariablen/CO2-Konzentration.page.md	branch=1	input/intro-notes/StructureDefinition-mii-pr-lungenfunktion-co2-konzentration-intro.md	compact match on mii-pr-lungenfunktion-co2-konzentration (1 candidate artefact; intro note already present)
5.4c page-routing	map rows=57 retired=1 coverage=ok	map=migration-log/page-map.generated.tsv
```
...
Rows: **57** total - 56 routed source pages (56 from the primary tree, 0 union pages outside it) and 1 RETIRED guide-tree summary row(s).
