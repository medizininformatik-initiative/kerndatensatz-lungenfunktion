...
Diese Seite listet die FHIR-Profile des Moduls **Lungenfunktion (Pulmonary Function)**. Als
...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatz-lungenfunktion/blob/main/docs/recipes/add-a-profile.md) in diesem Repository sowie die
