...
* Umgebungsvariablen 0..1 BackboneElement "Umgebungsvariablen" "Umgebungsvariablen zur Beschreibung des Patientenumfeld"
  * Umgebung 0..1 BackboneElement "Umgebung" "Umgebung in der der Messwert aufgenommen wurde"
    * Typ 0..1 http://hl7.org/fhir/StructureDefinition/CodeableConcept "Typ" "Typ der Umgebung"
    * Lokalisation 0..1 http://hl7.org/fhir/StructureDefinition/CodeableConcept "Lokalisation" "Lokalisation der Umgebung, zur Dokumentation von Innen oder Außen"
...
* Umgebungsvariablen -> ""
  * Umgebung -> "Location"
    * Typ -> "Location.type"
    * Lokalisation -> "Location.physicalType"
