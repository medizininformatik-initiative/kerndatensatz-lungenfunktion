...
* code.coding[loinc] from MII_VS_Lufu_LNC_FEV_FVC (required)
...
* component[percentPredicted].code.coding[sct] from MII_VS_Lufu_LNC_FEV_FVC (required)
* component[percentPredicted].code.coding[loinc] from MII_VS_Lufu_LNC_FEV_FVC (required)