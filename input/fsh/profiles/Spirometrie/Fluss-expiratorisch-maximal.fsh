...
Description: "Dieses Profil beschreibt die Messung des maximalen exspiratorischen Fluss."
...
* insert Translation(^description, en-US, The profile describes a observation for the maximum exspiratory flow.)
//Meta
