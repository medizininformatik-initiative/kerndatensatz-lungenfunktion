//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_FEV_VCMAX
Parent: Observation
Id: mii-pr-lungenfunktion-fev-vcmax
Title: "MII PR Lungenfunktion FEV VCMAX"
Description: "Dieses Beobachtung beschreibt den prozentualen Anteil der maximalen Vitalkapazität am forcierten, exspiratorischen Volumen."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-fev-vcmax"
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_FEV_VCMAX)
* insert Translation(^title, en-US, MII PR Lungfunction FEV VCMAX)
