//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_VCIN
Parent: Observation
Id: mii-pr-lungenfunktion-vcin
Title: "MII PR Lungenfunktion VCIN"
Description: "Dieses Profil beschreibt die Messung der inspiratorischen Vitalkapzität."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-vcin"
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_VCIN)
* insert Translation(^title, en-US, MII PR Lungfunction VCIN)
