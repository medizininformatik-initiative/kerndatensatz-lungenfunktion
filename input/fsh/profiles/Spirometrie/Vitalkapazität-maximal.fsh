//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_VCMAX
Parent: Observation
Id: mii-pr-lungenfunktion-vcmax
Title: "MII PR Lungenfunktion VC MAX"
Description: "Dieses Profil beschreibt die Messung der maximalen Vitalkapazität."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-vcmax"
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_VCMAX)
* insert Translation(^title, en-US, MII PR Lungfunction VC MAX)
