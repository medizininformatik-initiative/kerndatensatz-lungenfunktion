//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_FEV_VCIN
Parent: Observation
Id: mii-pr-lungenfunktion-fev-vcin
Title: "MII PR Lungenfunktion FEV VCIN"
Description: "Dieses Beobachtung beschreibt den prozentualen Anteil des inspiratorischen Vitalkapzität am forcierten, exspiratorischen Volumen."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-fev-vcin"
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_FEV_VCIN)
* insert Translation(^title, en-US, MII PR Lungfunction FEV VCIN)
