//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_Tiffeneau
Parent: Observation
Id: mii-pr-lungenfunktion-tiffeneau
Title: "MII PR Lungenfunktion Tiffeneau"
Description: "Dieses Profil beschreibt die Messung des Tiffeneau-Index."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-tiffeneau"
//Translation Meta
