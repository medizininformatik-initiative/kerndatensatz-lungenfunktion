//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_Sequenznummer
Parent: Observation
Id: mii-pr-lungenfunktion-sequenznummer
Title: "MII PR Lungenfunktion Sequenznummer"
Description: "Dieses Profil beschreibt die Messung der Sequenznummer."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-sequenznummer"
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_Sequencenumber)
* insert Translation(^title, en-US, MII PR Lungfunction Sequencenumber)
* insert Translation(^description, en-US, The profile describes a observation for the sequencenumber.)
//Meta
