...
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_Provokationtest)
* insert Translation(^title, en-US, MII PR Lungfunction Provokationtest)
* insert Translation(^description, en-US, The profile describes a diagnostic report for a provokation test.)
//Meta
