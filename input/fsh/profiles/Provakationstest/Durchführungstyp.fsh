//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_Durchfuehrungstyp
Parent: Observation
Id: mii-pr-lungenfunktion-kco-durchfuehrungstyp
Title: "MII PR Lungenfunktion Durchführungstyp"
Description: "Dieses Profil beschreibt die Messung des Durchführungstyp."
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-durchführungstyp"
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_Procedure_Type)
* insert Translation(^title, en-US, MII PR Lungfunction Procedure Type)
* insert Translation(^description, en-US, The profile describes a observation for the proceduretype.)
//Meta
