//EXAMPLE Profile
//Head
Profile: MII_PR_Lungenfunktion_Gewicht
Parent: Observation
...
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_Weight)
* insert Translation(^title, en-US, MII PR Lungfunction Weight)
...
* valueQuantity.unit = "ug"
* valueQuantity.system MS
* valueQuantity.system = $ucum
* valueQuantity.code MS
* valueQuantity.code = $ucum#ug
* interpretation MS
...
* component[predicted].valueQuantity.unit = "ug"
* component[predicted].valueQuantity.system = $ucum
* component[predicted].valueQuantity.code = $ucum#ug
