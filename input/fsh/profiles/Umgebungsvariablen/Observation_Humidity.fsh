//Head
Profile: MII_PR_Lungenfunktion_Luftfeuchtigkeit
Parent: Observation
...
* insert Translation(^description, en-US, The profile describes a observation for humidity.)
//Meta
...
* code.coding contains
    sct 0..1
* code.coding[sct].code = $SCT-version#3525006 "Humidity (physical force)"
