...
* code.coding[sct] = $sct#251952002 "Transfer coefficient (respiratory measure) (observable entity)"
...
* component[percentPredicted].code.coding[loinc] from MII_VS_Lufu_LNC_KCO (required)
