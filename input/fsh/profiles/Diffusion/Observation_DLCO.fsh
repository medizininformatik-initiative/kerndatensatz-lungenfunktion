...
* code.coding[sct] = $sct#1366665001 "Single breath carbon monoxide diffusing capacity (observable entity)"
...
* component[percentPredicted].code.coding[loinc] from MII_VS_Lufu_LNC_DLCO (required)
