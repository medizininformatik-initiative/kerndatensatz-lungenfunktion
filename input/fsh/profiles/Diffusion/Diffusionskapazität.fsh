...
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_DLCO)
* insert Translation(^title, en-US, MII PR Lungenfunktion DLCO)
* insert Translation(^description, en-US, The profile describes the diffusioncapacity of carbon monoxid.)
//Meta
