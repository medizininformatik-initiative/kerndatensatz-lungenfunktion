...
//Translation Meta
* insert Translation(^name, en-US, MII_PR_Lungfunction_FRC_SB)
* insert Translation(^title, en-US, MII PR Lungfunction FRC SB)
* insert Translation(^description, en-US, The profile describes a observation for the functional residualcapacity in single-breath-procedure.)
//Meta
