...
* code.coding[loinc] from MII_VS_Lufu_LNC_sR (required)
* code.coding[sct] = $sct#1366667009 "Specific airway resistance (observable entity)"
...
* component[percentPredicted].code.coding[loinc] from MII_VS_Lufu_LNC_sR (required)