...
The hand-authored intro to it is on the page
[MII ImplementationGuide Resource](ImplementationGuide-mii-ig-lungenfunktion.html).
...
This module offers no further downloads beyond the package and the artifact
serializations listed above.
