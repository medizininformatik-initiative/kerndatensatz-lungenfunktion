...
This page lists the FHIR profiles of the **Lungenfunktion (Pulmonary Function)** module. As a
...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatz-lungenfunktion/blob/main/docs/recipes/add-a-profile.md) in this repository, and the MII naming
