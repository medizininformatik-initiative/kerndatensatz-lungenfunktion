...
Technical guidance for DIC implementers on implementing the profiles of the **Lungenfunktion (Pulmonary Function)** module (ETL from primary systems, FHIR API, validation).
