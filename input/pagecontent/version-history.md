...
The **Lungenfunktion (Pulmonary Function)** module follows the KDS calendar-versioning (CalVer)
...
This module follows the KDS versioning scheme without additions of its own;
there is no separate support window or deprecation policy.
