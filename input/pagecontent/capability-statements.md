...
The CapabilityStatements of the **Lungenfunktion (Pulmonary Function)** module describe the expected server/client capabilities (supported resources and interactions).
