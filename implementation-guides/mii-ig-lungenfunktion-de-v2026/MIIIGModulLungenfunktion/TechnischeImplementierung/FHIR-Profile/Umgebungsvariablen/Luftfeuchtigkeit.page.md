...
where url = 'https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/LogicalModel/Lungenfunktion'
    for differential.element where id.contains('Lungenfunktion.Umgebungsvariablen.Luftfeuchtigkeit')
    select
        FHIR: mapping[0].map,
        Datensatz: path,
...
{{json:fsh-generated/resources/Observation-mii-exa-lungenfunktion-luftfeuchtigkeit.json}}
